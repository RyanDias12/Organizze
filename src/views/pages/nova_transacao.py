    ...
    def page(self, page: ft.Page):
        ...
        def mudar_tipo(novo_tipo):
            ...
            if tipo == "receita":
                ...
                toggle_despesa.bgcolor = "transparent"
                toggle_despesa.content = ft.Text("Despesa", color="black")
            else:
                toggle_despesa.bgcolor = "#EF4444"
                toggle_despesa.content = ft.Text("Despesa", color="white")
                toggle_receita.bgcolor = "transparent"
                toggle_receita.content = ft.Text("Receita", color="black")
        ...
        toggle_despesa = ft.Container(
            expand=True,
            height=40,
            border_radius=10,
            alignment=ft.Alignment(0, 0),
            content=ft.Text("Despesa"),
            on_click=lambda e: mudar_tipo("despesa")
        )
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    ft.Container(
                        ...
                        content=ft.Row(
                            controls=[toggle_receita, toggle_despesa]
                        )
                    ),
                    valor_input,
                    descricao_input,
