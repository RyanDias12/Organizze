...
class Nova_despesa_view:
    ...
    def page(self, page: ft.Page):
        ...
        # =========================
        # SNACKBAR (VIA OVERLAY - INFALÍVEL)
        # =========================
        def mostrar_snackbar(msg, cor="red"):
            ...
            # Adicionamos ele na lista de overlay da página
            page.overlay.append(snack)

            # Atualizamos a página para ele aparecer
            page.update()
